...
;
	...
	($mol_mem(($.$club_menu.prototype), "Rooms_all"));
...
;
	($.$club_feed) = class $club_feed extends ($.$mol_view) {
		feed_body(){
			return [];
		}
		Ord_activity(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"ordering": "activity"});
			(obj.title) = () => ("Фид");
			return obj;
		}
		Ord_new(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"ordering": "new"});
			(obj.title) = () => ("Новое");
			return obj;
		}
		Ord_hot(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"ordering": "hot"});
			(obj.title) = () => ("Обсуждаемое");
			return obj;
		}
		Ord_top(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"ordering": "top_month"});
			(obj.title) = () => ("Лучшее");
			return obj;
		}
		Ord_top_week(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"ordering": "top_week"});
			(obj.title) = () => ("За неделю");
			return obj;
		}
		Ord_top_month(){
	...
	($mol_mem(($.$club_feed.prototype), "Ord_activity"));
	($mol_mem(($.$club_feed.prototype), "Ord_new"));
	($mol_mem(($.$club_feed.prototype), "Ord_hot"));
	($mol_mem(($.$club_feed.prototype), "Ord_top"));
	($mol_mem(($.$club_feed.prototype), "Ord_top_week"));
	($mol_mem(($.$club_feed.prototype), "Ord_top_month"));
	($mol_mem(($.$club_feed.prototype), "Ord_top_year"));
	($mol_mem(($.$club_feed.prototype), "page"));
	($mol_mem(($.$club_feed.prototype), "Ordering"));
	($mol_mem(($.$club_feed.prototype), "Ordering_extra"));
	($mol_mem(($.$club_feed.prototype), "Posts"));
	($mol_mem(($.$club_feed.prototype), "Pager"));
...
(function ($) {
    class $club_api extends $mol_object {
        ...
        static fetch_from(base, url, with_token) {
        ...
        static fetch_json(url) {
            try {
                return this.fetch_from(this.prod, url, false);
            }
            catch (error) {
        ...
        static feed_type(next) {
            return $mol_state_arg.value('type', next) ?? 'all';
        }
        static feed_page(next) {
            if (next !== undefined) {
        ...
        static whoami() {
            return this.fetch_json_auth(`/user/me.json`);
        }
        static bookmarks() {
    ...
    __decorate([
        $mol_mem
    ], $club_api, "feed_ordering", null);
    __decorate([
        $mol_mem
    ], $club_api, "feed_type", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem_key
    ], $club_api, "post_comments", null);
    __decorate([
        $mol_mem_key
    ], $club_api, "profile", null);
    __decorate([
        $mol_mem_key
    ], $club_api, "profile_tags", null);
    __decorate([
        $mol_mem_key
    ], $club_api, "profile_badges", null);
    __decorate([
        $mol_mem_key
    ], $club_api, "profile_achievements", null);
    __decorate([
        $mol_mem
    ], $club_api, "whoami", null);
    __decorate([
        $mol_mem
    ], $club_api, "bookmarks", null);
    __decorate([
        $mol_mem
    ], $club_api, "rooms", null);
    __decorate([
        $mol_mem
    ], $club_api, "friends", null);
    $.$club_api = $club_api;
})($ || ($ = {}));
...
;
	($.$club_card) = class $club_card extends ($.$mol_link) {
		...
		Comments_count(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.comments_label()));
			return obj;
		}
		Footer(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Room_label()), (this.Comments_count())]);
			return obj;
		}
		upvotes(){
			return "";
	...
	($mol_mem(($.$club_card.prototype), "Room_label"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $club_feed.prototype, "page", null);
        __decorate([
            $mol_mem
        ], $club_feed.prototype, "feed", null);
        __decorate([
            $mol_mem
        ], $club_feed.prototype, "is_top", null);
        __decorate([
            $mol_mem
        ], $club_feed.prototype, "Ord_top", null);
        __decorate([
            $mol_mem
        ], $club_feed.prototype, "feed_body", null);
        __decorate([
            $mol_mem
...
;
	($.$club_settings) = class $club_settings extends ($.$mol_page) {
		Title(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Настройки");
			return obj;
		...
		Token_input(){
			...
			(obj.hint) = () => ("Вставьте токен из кук vas3k.club");
			return obj;
		}
		Token_label(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ("Токен авторизации");
			(obj.content) = () => ([(this.Token_input())]);
			return obj;
		}
		Token_help(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ("Откройте vas3k.club, в DevTools найдите куку **token** и вставьте сюда. Это позволит читать приватные посты и комментарии.");
			return obj;
		}
		title(){
			return "Настройки";
	...
	($mol_mem(($.$club_settings.prototype), "Title"));
	($mol_mem(($.$club_settings.prototype), "Lighter"));
	($mol_mem(($.$club_settings.prototype), "Theme_row"));
	($mol_mem(($.$club_settings.prototype), "token"));
	($mol_mem(($.$club_settings.prototype), "Token_input"));
	($mol_mem(($.$club_settings.prototype), "Token_label"));
	($mol_mem(($.$club_settings.prototype), "Token_help"));
...
(function ($) {
    ...
    (function ($$) {
        class $club_settings extends $.$club_settings {
            token(next) {
                return $club_api.token(next);
            }
        }
        __decorate([
            $mol_mem
        ], $club_settings.prototype, "token", null);
...
;
	($.$club) = class $club extends ($.$mol_page) {
		Theme(){
		...
		Logo_img(){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ("https://vas3k.club/static/images/logo/logo-128.png");
			return obj;
		}
		Logo_right(){
			const obj = new this.$.$mol_paragraph();
		...
		Menu_compose(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://vas3k.club/create/");
			(obj.sub) = () => ([(this.Compose_icon()), (this.Compose_text())]);
			return obj;
		}
		Bookmarks_icon(){
		...
		User_avatar(){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ((this.current_user_avatar()));
			return obj;
		}
		Menu_avatar(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({
				"user": (this.current_user_slug()), 
				"post": null, 
				"bookmarks": null, 
				"rooms": null, 
				"settings": null, 
		...
		Main(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Sidebar()), (this.Content())]);
			return obj;
		}
		Footer_about(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://vas3k.club/docs/about/");
			(obj.title) = () => ("О Клубе");
			return obj;
		}
		Footer_values(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://vas3k.club/docs/values/");
			(obj.title) = () => ("Наши ценности");
			return obj;
		}
		Footer_team(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://vas3k.club/crew/");
			(obj.title) = () => ("Команда");
			return obj;
		}
		Footer_privacy(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://vas3k.club/docs/privacy_policy/");
			(obj.title) = () => ("Политика приватности");
			return obj;
		}
		Footer_contact(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://vas3k.club/docs/contact/");
			(obj.title) = () => ("Связаться с нами");
			return obj;
		}
		Footer_invite(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://vas3k.club/invites/");
			(obj.title) = () => ("Пригласить друга");
			return obj;
		}
		Footer_opensource(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://github.com/vas3k/vas3k.club");
			(obj.title) = () => ("Опенсорс");
			return obj;
		}
		Footer_payment(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("https://vas3k.club/docs/blocked_dolor/");
			(obj.title) = () => ("Оплата из России");
			return obj;
		}
		Footer_cc(){
			const obj = new this.$.$mol_paragraph();
		...
		Footer(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Footer_left()), (this.Footer_right())]);
			return obj;
		}
		plugins(){
			return [(this.Theme())];
		...
		Feed(){
			const obj = new this.$.$club_feed();
			return obj;
		}
		Settings(){
			const obj = new this.$.$club_settings();
			return obj;
		}
	};
	($mol_mem(($.$club.prototype), "Theme"));
	($mol_mem(($.$club.prototype), "Logo_left"));
	($mol_mem(($.$club.prototype), "Logo_img"));
	($mol_mem(($.$club.prototype), "Logo_right"));
	($mol_mem(($.$club.prototype), "Logo"));
	($mol_mem(($.$club.prototype), "Compose_icon"));
	($mol_mem(($.$club.prototype), "Compose_text"));
	...
	($mol_mem(($.$club.prototype), "Footer_about"));
	($mol_mem(($.$club.prototype), "Footer_values"));
	($mol_mem(($.$club.prototype), "Footer_team"));
	($mol_mem(($.$club.prototype), "Footer_privacy"));
	($mol_mem(($.$club.prototype), "Footer_contact"));
	($mol_mem(($.$club.prototype), "Footer_invite"));
	($mol_mem(($.$club.prototype), "Footer_opensource"));
	($mol_mem(($.$club.prototype), "Footer_payment"));
	($mol_mem(($.$club.prototype), "Footer_cc"));
	($mol_mem(($.$club.prototype), "Footer_left"));
	($mol_mem(($.$club.prototype), "Lighter"));
	($mol_mem(($.$club.prototype), "Footer_right"));
	($mol_mem(($.$club.prototype), "Footer"));
	($mol_mem(($.$club.prototype), "Feed"));
	($mol_mem(($.$club.prototype), "Settings"));
...
;
	($.$club_post) = class $club_post extends ($.$mol_page) {
		...
		Article_header(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.article_header_content()));
			return obj;
		}
		upvotes_label(){
			return "";
		...
		Comments_count(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.comments_count_label()));
			return obj;
		}
		Comments_title(){
			const obj = new this.$.$mol_view();
		...
		Comments_section(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Comments_title()), (this.Comments_list())]);
			return obj;
		}
		Post_title_text(){
			const obj = new this.$.$mol_paragraph();
		...
		Post_views(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.views_label()));
			return obj;
		}
		Post_actions(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Post_date()), (this.Post_views())]);
			return obj;
		}
		Author_avatar_small(){
			const obj = new this.$.$mol_image();
		...
		Battle_side_a_text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.battle_side_a()));
			return obj;
		}
		Battle_side_a(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Battle_side_a_text())]);
			return obj;
		}
		Battle_vs_text(){
			const obj = new this.$.$mol_paragraph();
		...
		Battle_side_b_text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.battle_side_b()));
			return obj;
		}
		Battle_side_b(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Battle_side_b_text())]);
			return obj;
		}
		battle_args_a_label(){
			return "";
		...
		Battle_args_a(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.battle_args_a_label()));
			return obj;
		}
		battle_args_b_label(){
			return "";
		...
		Battle_args_b(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.battle_args_b_label()));
			return obj;
		}
		Battle_stats_args(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Battle_args_a()), (this.Battle_args_b())]);
			return obj;
		}
		Battle_graph_a(){
			const obj = new this.$.$mol_view();
		...
		Battle_stats_graph(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Battle_graph_a()), (this.Battle_graph_b())]);
			return obj;
		}
		post_type(){
			return "";
		...
		Battle_stats(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Battle_stats_args()), (this.Battle_stats_graph())]);
			return obj;
		}
	};
	...
	($mol_mem(($.$club_post.prototype), "Comments_title"));
	($mol_mem(($.$club_post.prototype), "Comments_list"));
	($mol_mem(($.$club_post.prototype), "Comments_section"));
	...
	($mol_mem(($.$club_post.prototype), "Battle_side_a_text"));
	($mol_mem(($.$club_post.prototype), "Battle_side_a"));
	($mol_mem(($.$club_post.prototype), "Battle_vs_text"));
	($mol_mem(($.$club_post.prototype), "Battle_vs"));
	($mol_mem(($.$club_post.prototype), "Battle_side_b_text"));
	($mol_mem(($.$club_post.prototype), "Battle_side_b"));
	($mol_mem(($.$club_post.prototype), "Battle_args_a"));
	($mol_mem(($.$club_post.prototype), "Battle_args_b"));
	($mol_mem(($.$club_post.prototype), "Battle_stats_args"));
	($mol_mem(($.$club_post.prototype), "Battle_graph_a"));
	($mol_mem(($.$club_post.prototype), "Battle_graph_b"));
	($mol_mem(($.$club_post.prototype), "Battle_stats_graph"));
	...
	($mol_mem(($.$club_post.prototype), "Battle_title"));
	($mol_mem(($.$club_post.prototype), "Battle_stats"));
...
;
	($.$club_comment) = class $club_comment extends ($.$mol_view) {
		author_slug(){
			return "";
		}
		author_avatar(){
		...
		Side(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Avatar_link()), (this.Thread_ruler())]);
			return obj;
		}
		author_name(){
			return "";
		...
		Author_block(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Author_link()), (this.Author_position())]);
			return obj;
		}
		post_link_content(){
			return [];
		...
		Post_link_block(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.post_link_content())]);
			return obj;
		}
		created_date(){
			return "";
		...
		Post_link(){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"post": (this.post_arg())});
			(obj.sub) = () => ([(this.Post_link_title())]);
			return obj;
		}
	};
	($mol_mem(($.$club_comment.prototype), "Avatar"));
	($mol_mem(($.$club_comment.prototype), "Avatar_link"));
	($mol_mem(($.$club_comment.prototype), "Thread_ruler"));
	($mol_mem(($.$club_comment.prototype), "Side"));
	($mol_mem(($.$club_comment.prototype), "Author_name"));
	($mol_mem(($.$club_comment.prototype), "Author_link"));
	($mol_mem(($.$club_comment.prototype), "Author_position"));
	($mol_mem(($.$club_comment.prototype), "Author_block"));
	($mol_mem(($.$club_comment.prototype), "Post_link_block"));
	($mol_mem(($.$club_comment.prototype), "Date"));
	($mol_mem(($.$club_comment.prototype), "Header"));
	($mol_mem(($.$club_comment.prototype), "Rating"));
	($mol_mem(($.$club_comment.prototype), "Body"));
	($mol_mem(($.$club_comment.prototype), "Footer"));
	($mol_mem(($.$club_comment.prototype), "Post_link_title"));
	($mol_mem(($.$club_comment.prototype), "Post_link_prefix"));
	($mol_mem(($.$club_comment.prototype), "Post_link"));
...
(function ($) {
    ...
    (function ($$) {
        class $club_comment extends $.$club_comment {
            ...
            author_position() {
                return this.comment_data()?.author?.position ?? '';
            }
            created_date() {
...
var $;
(function ($) {
    $mol_style_attach("club/comment/comment.view.css", "[club_comment]:hover [club_comment_thread_ruler] {\n\topacity: 0.3;\n}\n\n[club_comment_side]:hover [club_comment_thread_ruler] {\n\topacity: 1;\n}\n\n[club_comment_thread_ruler] {\n\ttransition: opacity .3s;\n}\n");
})($ || ($ = {}));
    ...
    (function ($$) {
        class $club_post extends $.$club_post {
            ...
            publicity_label() {
                ...
                if (p === false)
                    return '🔒 Только для членов клуба';
            ...
            views_label() {
                const v = this.data()?.post?._club?.view_count;
                return v ? `👁 ${v}` : '';
            }
            content_text() {
        ...
        __decorate([
            $mol_mem
        ], $club_post.prototype, "data", null);
        __decorate([
            $mol_mem
        ], $club_post.prototype, "comments_data", null);
        __decorate([
            $mol_mem
...
var $;
(function ($) {
    $mol_style_attach("club/post/post.view.css", "[club_post_upvote]::before {\n\tcontent: '\\25B2';\n\tposition: absolute;\n\tfont-size: 18px;\n\ttop: 5px;\n\tleft: 50%;\n\ttransform: translateX(-50%);\n}\n\n[club_post_upvote]:hover {\n\tbackground-color: var(--mol_theme_text);\n\tcolor: var(--mol_theme_back);\n\tcursor: pointer;\n}\n\n[club_post_text_body] a {\n\tfont-weight: 600;\n}\n\n[club_post_text_body] a[target=\"_blank\"] {\n\ttext-decoration: underline;\n}\n");
})($ || ($ = {}));
    ...
    (function ($$) {
        ...
        $mol_style_define($club_post, {
            ...
            Battle_vs: {
                ...
                background: 'linear-gradient(108deg, #4C98D5 0%, #4C98D5 49%, #53AA68 50%, #53AA68 100%)',
            },
            Battle_vs_text: {
                font: {
                    size: '70%',
...
;
	($.$club_profile) = class $club_profile extends ($.$mol_page) {
		...
		Card_nickname(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.nickname_label()));
			return obj;
		}
		Card_name_row(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Card_fullname()), (this.Card_nickname())]);
			return obj;
		}
		position_label(){
			return "";
		...
		Card_position(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.position_label()));
			return obj;
		}
		Card_job(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Card_position())]);
			return obj;
		}
		location_label(){
			return "";
		...
		Card(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Card_photo()), (this.Card_info())]);
			return obj;
		}
		upvotes_label(){
			return "";
		...
		Status_respect(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Respect_number()), (this.Respect_text())]);
			return obj;
		}
		membership_label(){
			return "";
		...
		Membership_number(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.membership_label()));
			return obj;
		}
		Membership_text(){
			const obj = new this.$.$mol_paragraph();
		...
		Status_membership(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Membership_number()), (this.Membership_text())]);
			return obj;
		}
		comments_count_label(){
			return "";
		...
		Comments_text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.comments_text()));
			return obj;
		}
		Status_comments(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Comments_number()), (this.Comments_text())]);
			return obj;
		}
		posts_count_label(){
			return "";
		...
		Posts_number(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.posts_count_label()));
			return obj;
		}
		posts_text(){
			return "";
		...
		Posts_text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.posts_text()));
			return obj;
		}
		Status_posts(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Posts_number()), (this.Posts_text())]);
			return obj;
		}
		Statuses(){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$club_profile.prototype), "Back_icon"));
	($mol_mem(($.$club_profile.prototype), "Back"));
	($mol_mem(($.$club_profile.prototype), "Title"));
	($mol_mem(($.$club_profile.prototype), "Card_avatar"));
	($mol_mem(($.$club_profile.prototype), "Card_photo"));
	($mol_mem(($.$club_profile.prototype), "Card_fullname"));
	($mol_mem(($.$club_profile.prototype), "Card_nickname"));
	($mol_mem(($.$club_profile.prototype), "Card_name_row"));
	($mol_mem(($.$club_profile.prototype), "Card_position"));
	($mol_mem(($.$club_profile.prototype), "Card_job"));
	($mol_mem(($.$club_profile.prototype), "Card_location"));
	($mol_mem(($.$club_profile.prototype), "Card_bio"));
	($mol_mem(($.$club_profile.prototype), "Card_info"));
	($mol_mem(($.$club_profile.prototype), "Card"));
	($mol_mem(($.$club_profile.prototype), "Respect_number"));
	($mol_mem(($.$club_profile.prototype), "Respect_text"));
	($mol_mem(($.$club_profile.prototype), "Status_respect"));
	($mol_mem(($.$club_profile.prototype), "Membership_number"));
	($mol_mem(($.$club_profile.prototype), "Membership_text"));
	($mol_mem(($.$club_profile.prototype), "Status_membership"));
	($mol_mem(($.$club_profile.prototype), "Comments_number"));
	($mol_mem(($.$club_profile.prototype), "Comments_text"));
	($mol_mem(($.$club_profile.prototype), "Status_comments"));
	($mol_mem(($.$club_profile.prototype), "Posts_number"));
	($mol_mem(($.$club_profile.prototype), "Posts_text"));
	($mol_mem(($.$club_profile.prototype), "Status_posts"));
	($mol_mem(($.$club_profile.prototype), "Statuses"));
...
;
	($.$club_tag) = class $club_tag extends ($.$mol_view) {
		tag_name(){
			return "";
		}
		tag(){
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $club_profile.prototype, "data", null);
        __decorate([
            $mol_mem
...
;
	($.$club_bookmarks) = class $club_bookmarks extends ($.$mol_page) {
		Back_icon(){
			const obj = new this.$.$mol_icon_arrow_left();
			return obj;
		}
	...
	($mol_mem(($.$club_bookmarks.prototype), "Back_icon"));
	($mol_mem(($.$club_bookmarks.prototype), "Back"));
	($mol_mem(($.$club_bookmarks.prototype), "Title"));
	($mol_mem(($.$club_bookmarks.prototype), "Posts"));
	($mol_mem(($.$club_bookmarks.prototype), "page"));
	($mol_mem(($.$club_bookmarks.prototype), "Pager"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $club_bookmarks.prototype, "data", null);
        __decorate([
            $mol_mem
...
;
	($.$club_rooms) = class $club_rooms extends ($.$mol_page) {
		Back_icon(){
			const obj = new this.$.$mol_icon_arrow_left();
			return obj;
		}
		...
		Room_title(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.room_title(id)));
			return obj;
		}
		Room_subtitle(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.room_subtitle(id)));
			return obj;
		}
		Room_members(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.room_members(id)));
			return obj;
		}
		Room(id){
			const obj = new this.$.$mol_view();
	...
	($mol_mem(($.$club_rooms.prototype), "Back_icon"));
	($mol_mem(($.$club_rooms.prototype), "Back"));
	($mol_mem(($.$club_rooms.prototype), "Title"));
	($mol_mem_key(($.$club_rooms.prototype), "Room_title"));
	($mol_mem_key(($.$club_rooms.prototype), "Room_subtitle"));
	($mol_mem_key(($.$club_rooms.prototype), "Room_members"));
	($mol_mem_key(($.$club_rooms.prototype), "Room"));
	($mol_mem(($.$club_rooms.prototype), "Rooms"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $club_rooms.prototype, "data", null);
        __decorate([
            $mol_mem
        ], $club_rooms.prototype, "rooms_list", null);
        $$.$club_rooms = $club_rooms;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
